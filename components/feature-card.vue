<template>
  <div class="featuresCard feature-card-feature-card">
    ...
    <div class="feature-card-container">
      <h3 class="feature-card-text1 heading3">{{ heading }}</h3>
      <span class="feature-card-text2 bodySmall">{{ subHeading }}</span>
    </div>
  </div>
</template>
...
export default {
  ...
  props: {
    heading: {
      type: String,
      default: 'Sprzedaż Rowerów',
    },
    subHeading: {
      type: String,
      default:
        'Nasz sklep oferuje rowery najwyższej klasy i jakości.  Nasza oferta obejmuje rowery górskie, szosowe, miejskie, trekkingowe oraz wiele innych typów, dostępnych w różnych rozmiarach, kolorach i konfiguracjach. Nasi uzdolnieni specjaliści pomogą ci w wyborze wymarzonego roweru!',
    },
  },
}
</script>
