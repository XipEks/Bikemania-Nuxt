<template>
  <div
    class="featuresCard feature-card1-feature-card"
  ...
  >
    ...
    <div class="feature-card1-container">
      <h3 class="feature-card1-text1 heading3">{{ heading }}</h3>
      <span class="feature-card1-text2 bodySmall">{{ subHeading }}</span>
    </div>
  </div>
</template>
...
export default {
  ...
  props: {
    heading: {
      type: String,
      default: 'Akcesoria i Części Rowerowe',
    },
    subHeading: {
      type: String,
      default:
        'W sklepe "BikeMania" jest szeroki wybór akcesoriów i części rowerowych, które pomogą Ci ulepszyć i dostosować Twój rower do Twoich potrzeb. Oferujemy różnorodne produkty, takie jak kaski, oświetlenie, torby, blokady, bagażniki i wiele innych, aby zapewnić Ci kompletny zestaw do każdej podróży rowerowej.',
    },
