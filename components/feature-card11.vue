<template>
  <div
    class="featuresCard feature-card11-feature-card"
  ...
  >
    ...
    <div class="feature-card11-container">
      <h3 class="feature-card11-text1 heading3">{{ heading }}</h3>
      <span class="feature-card11-text2 bodySmall">{{ subHeading }}</span>
    </div>
  </div>
</template>
...
export default {
  ...
  props: {
    ...
    subHeading: {
      type: String,
      default:
        'Oferujemy kompleksową usługę serwisu i napraw rowerów w sklepie "BikeMania". Nasi doświadczeni mechanicy są gotowi zapewnić Twojemu rowerowi najlepszą opiekę, niezależnie od tego, czy potrzebuje on drobnej regulacji, wymiany części, czy też pełnego przeglądu',
    },
  },
}
</script>
